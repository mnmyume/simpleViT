...
def load_cifar10_test_data(cifar10_dir):
    ...
    # load test dataset
    test_data, test_labels = load_cifar10_batch(os.path.join(cifar10_dir, 'test_batch'))
...
test_dataset = CIFAR10Dataset(X_test, y_test, processor)
...
print(f"Loss on CIFAR-10 test set: {total_loss:.4f}")
